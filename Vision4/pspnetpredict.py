...
from model.pspnet import PSPNet as pspnet
...
class PSPNetPredict(object):
    ...
    #   初始化PSPNET
    def __init__(self, model_path="", backbone="mobilenet", num_classes=21, cuda=True, blend=True):
