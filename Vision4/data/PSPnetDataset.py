...
class PSPnetDataset(Dataset):
    def __init__(self, train_lines, image_size, num_classes, random_data, image_path="", annotation_path=""):
    ...
    def __getitem__(self, index):
        ...
        # 从文件中读取图像
        jpg = Image.open(self.train_image_path + '/' + name + ".jpg")
        png = Image.open(self.annotation_path + '/' + name + ".png")
