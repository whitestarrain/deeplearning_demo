...
if __name__ == "__main__":
    gt_dir = "datasets/Annotation/val_segmentations"
    pred_dir = "datasets/out/miou_pr_dir"
    png_name_list = open("datasets/Segmentation/val_id.txt", 'r').read().splitlines()
    #   分类个数+1
    #   2+1
    num_classes = 20
    #   区分的种类，和json_to_dataset里面的一样
    name_classes = ["Background", "Hat", "Hair", "Glove", "Sunglasses", "Upper-clothes", "Dress", "Coat", "Socks",
