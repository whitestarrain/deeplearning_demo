...
from model.yolo_training import Generator, YOLOLoss
...
def fit_one_epoch(net, yolo_losses, epoch, epoch_size, epoch_size_val, gen, genval, Epoch, cuda):
    ...
    torch.save(model.state_dict(), 'checkpoints/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.pth' % (
...
if __name__ == "__main__":
    ...
    #   获得图片路径和标签
    annotation_path = 'image_annotation.txt'
