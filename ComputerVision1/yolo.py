...
class YOLO(object):
    _defaults = {
        "model_path": 'checkpoints/yolo4_weights.pth',
        "anchors_path": 'conf/yolo_anchors.txt',
    ...
    #   初始化YOLO
    def __init__(self, cuda=True, model_path='checkpoints/yolo4_weights.pth', anchors_path="conf/yolo_anchors.txt",
                 classes_path="conf/classes.txt", **kwargs):
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='conf/simhei.ttf',
