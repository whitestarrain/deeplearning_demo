...
def train():
    ...
    inception4_model = InceptionV4(num_classes=2).to(device)
    ...
    # 读取全部数据
    dataset = ImageFolder(root=DefaultConfig.data_root,
    ...
    train_dataset = DataLoader(train_dataset,
                               ...
                               shuffle=DefaultConfig.is_shuffle,
    ...
    # 定义优化器
    optimizer = optim.Adam(inception4_model.parameters(),
                           lr=DefaultConfig.inceptionv4_lr)
